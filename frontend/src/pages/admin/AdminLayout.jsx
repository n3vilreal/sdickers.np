...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen w-screen bg-[#111111]">
      <aside className="hidden lg:flex w-64 bg-black flex-col justify-between py-8 px-6 sticky top-0 h-screen">
        {SidebarContent}
      </aside>
      {sidebarOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          <div
            ...
            onClick={() => setSidebarOpen(false)}
          />
          <aside className="relative w-64 bg-black flex flex-col justify-between py-8 px-6 h-full">
            <button
      ...
      <main className="flex-1 min-w-0 p-4 sm:p-10 overflow-x-auto">
        <button
          className="lg:hidden mb-4 text-white text-2xl cursor-pointer"
